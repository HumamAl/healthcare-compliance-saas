...
Multi-tenant compliance SaaS where a PE group, insurer, and physician practice each see only their own data — plus a rule-based risk scoring engine with triggered rationale per finding. Built a working version: {VERCEL_URL}
